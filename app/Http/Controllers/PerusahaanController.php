...
class PerusahaanController extends Controller
{
    ...
    public function create(){
        ...
        return view('perusahaan.create', compact('uppd'));
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            return redirect('/perusahaan/view')->with(['success' => 'Data Berhasil Disimpan !']);
            } catch (\Exception $e) {
    ...
    public function edit($id_wajibpajak){
        ...
        return view('perusahaan.edit', compact('perusahaan', 'uppd'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $data =  [
            ...
            return redirect('/perusahaan/view')->with(['success' => 'Data Berhasil Diiubah !']);
            } catch (\Exception $e) {
    ...
    public function hapus($id_wajibpajak)
    {
       ...
       if ($delete) {
           return redirect('/perusahaan/view')->with(['success' => 'Data Berhasil Dihapus !']);
       } else {
    ...
    public function reset($id_wajibpajak)
    {
       ...
       ->update($data);
       if ($update) {
           return redirect('/perusahaan/view')->with(['success' => 'Password Berhasil Direset !']);
       } else {
