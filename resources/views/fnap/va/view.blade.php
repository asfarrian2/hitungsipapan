                    ...
                    <table id="datatable" class="table table-striped table-bordered" width="100%">
                      ...
                      @foreach ($va as $d)
                        <tr>
                          ...
                          @csrf
                          <td>
                            <a href="/va/{{ $d->id_va }}/edit" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
                            <a class="hapus" href="#" data-id="{{ $d->id_va }}" title="Hapus Data"><i class="hapus fa fa-trash text-succsess btn btn-danger btn-sm" ></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Volume Air Yang Diambil dan/atau Dimanfaatkan (VA)</h5>
                <button type="button" class="fa fa-close close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form action="/va/store" method="POST" id="frmCabang">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/va/"+id_va+"/hapus"
    Swal.fire({
