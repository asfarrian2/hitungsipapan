          ...
          <div class="page-title">
            <div class="title_left">
             ...
             <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Data Luas Areal Tempat Pengambilan dan/atau Pemanfaatan Air (LP)</h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Lokasi Areal Pengambilan Air Permukaan</th>
                      ...
                      @foreach ($lp as $d)
                        <tr>
                          ...
                          @csrf
                          <td>
                            <a href="/lp/{{ $d->id_lp }}/edit" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
                            <a class="hapus" href="#" data-id="{{ $d->id_lp }}" title="Hapus Data"><i class="hapus fa fa-trash text-succsess btn btn-danger btn-sm" ></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Luas Areal Tempat Pengambilan dan/atau Pemanfaatan Air (LP)</h5>
                <button type="button" class="fa fa-close close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form action="/lp/store" method="POST" id="frmCabang">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                <span>Lokasi Areal Pengambilan Air Permukaan </span>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/lp/"+id_lp+"/hapus"
    Swal.fire({
