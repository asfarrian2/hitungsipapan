          ...
          <div class="page-title">
            <div class="title_left">
             ...
             <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Data Jenis Sumber Air (SA)</h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Sumber Air</th>
                      ...
                      @foreach ($sa as $d)
                        <tr>
                          ...
                          @csrf
                          <td>
                            <a href="/sa/{{ $d->id_sa }}/edit" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
                            <a class="hapus" href="#" data-id="{{ $d->id_sa }}" title="Hapus Data"><i class="hapus fa fa-trash text-succsess btn btn-danger btn-sm" ></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/sa/store" method="POST" id="frmCabang">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/sa/"+id_sa+"/hapus"
    Swal.fire({
