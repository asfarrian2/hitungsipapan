          ...
          <div class="page-title">
            <div class="title_left">
             ...
             <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kewenangan Pengelolaan Sumber Daya Air (KP)</h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" width="100%">
                      ...
                      @foreach ($kp as $d)
                        <tr>
                          ...
                          <td>{{ $d->klasifikasi_kp }}</td>
                          <td>{{ $d->bobot_kp }}%</td>
                          @csrf
                          <td>
                            <a href="/kp/{{ $d->id_kp }}/edit" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
                            <a class="hapus" href="#" data-id="{{ $d->id_kp }}" title="Hapus Data"><i class="hapus fa fa-trash text-succsess btn btn-danger btn-sm" ></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Kewenangan Pengelolaan Sumber Daya Air (KP)</h5>
                <button type="button" class="fa fa-close close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form action="/kp/store" method="POST" id="frmCabang">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/kp/"+id_kp+"/hapus"
    Swal.fire({
