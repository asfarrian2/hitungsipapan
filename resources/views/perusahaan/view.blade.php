             ...
             <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-sm-12">
                            <a href="/perusahaan/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i><span> Tambah</span></a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" width="100%">
                      ...
                      @foreach ($perusahaan as $d)
                        <tr>
                          ...
                          @csrf
                          <td>
                            <a href="/perusahaan/{{ $d->id_wajibpajak }}/edit" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/perusahaan/"+id_wajibpajak+"/hapus"
    Swal.fire({
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/perusahaan/"+id_wajibpajak+"/reset"
    Swal.fire({
