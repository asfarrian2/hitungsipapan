					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="/perusahaan/store" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">ID Wajib Pajak
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_wajibpajak" id="first-name" required="required" class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
                                                ...
                                                <a href="/perusahaan/view" class="btn btn-dark">Batal</a>
											</div>
										</div>
									</form>
								</div>
